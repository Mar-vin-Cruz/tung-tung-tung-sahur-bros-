...
# --- Animaciones caminar ---
CaminarD = [
    pygame.image.load("RedHat/RedHat_camina1.png"),
    pygame.image.load("RedHat/RedHat_camina2.png"),
]
AnimD = [pygame.transform.scale(imagen1, (96,96)) for imagen1 in CaminarD]

CaminarI = [
    pygame.image.load("RedHat/RedHat_Fcaminar1.png"),
    pygame.image.load("RedHat/RedHat_Fcaminar2.png"),
]
AnimI = [pygame.transform.scale(imagen2, (96,96)) for imagen2 in CaminarI]

# --- Sprites volar ---
VolarD = pygame.transform.scale(pygame.image.load("RedHat/RedHat_Salto.png"), (96,96))
